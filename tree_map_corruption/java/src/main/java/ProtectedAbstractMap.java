...
public abstract class ProtectedAbstractMap<K,V> implements Map<K,V> {
    /**
     * Sole constructor.  (For invocation by subclass constructors, typically
     * implicit.)
     */
    protected ProtectedAbstractMap() {
    }
    ...
    public Set<K> keySet() {
        ...
        if (ks == null) {
            ks = new AbstractSet<K>() {
                ...
                public int size() {
                    return ProtectedAbstractMap.this.size();
                }

                public boolean isEmpty() {
                    return ProtectedAbstractMap.this.isEmpty();
                }

                public void clear() {
                    ProtectedAbstractMap.this.clear();
                }

                public boolean contains(Object k) {
                    return ProtectedAbstractMap.this.containsKey(k);
                }
            };
            keySet = ks;
        }
        ...
        if (vals == null) {
            vals = new AbstractCollection<V>() {
                ...
                public boolean contains(Object v) {
                    return ProtectedAbstractMap.this.containsValue(v);
                }
            };
            values = vals;
        }
    ...
    /**
     * Returns a shallow copy of this {@code ProtectedAbstractMap} instance: the keys
     * and values themselves are not cloned.
     *
     * @return a shallow copy of this map
     */
    protected Object clone() throws CloneNotSupportedException {
        ProtectedAbstractMap<?,?> result = (ProtectedAbstractMap<?,?>)super.clone();
        result.keySet = null;
        result.values = null;
        return result;
    }
